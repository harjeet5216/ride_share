...
class RidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ride" do
    assert_difference('Ride.count') do
      post rides_url, params: { ride: { drop: @ride.drop, pickup: @ride.pickup, user_id: @ride.user_id } }
    end
  ...
  test "should update ride" do
    patch ride_url(@ride), params: { ride: { drop: @ride.drop, pickup: @ride.pickup, user_id: @ride.user_id } }
